...
const EXECUTION_EVIDENCE = [
  ...
  'role-specific file/section index for Verify covering current receipts, requirements, plan, implementation summary',
  'loads current receipts, requirements and implementation summary through that index',
  'judges semantic coverage and scans source debt',
  'role-specific file/section index for Architect covering the complete diff, relevant unchanged dependencies, accepted requirements, fresh Verify and relevant artifact content',
  'exact contract, ledger, referenced receipt and subject bytes remain available',
  "Architect opens underlying raw evidence or historical output when a concrete concern requires it, without routinely repeating Verify's receipt audit",
